...
namespace TDiss
{
	...
	bool Builder::SaveTables(const std::wstring& outPath)
	{
		size_t i;

		FileUtil::ScopedFileWin32 f;
		if (f.Open(outPath, GENERIC_WRITE, CREATE_ALWAYS))
		{
	...
	bool Builder::SaveMnemocis(const std::wstring& outHeader, const std::wstring& outSource)
	{
		FileUtil::ScopedFileWin32 fh, fs;
		if (!fh.Open(outHeader, GENERIC_WRITE, CREATE_ALWAYS) || !fs.Open(outSource, GENERIC_WRITE, CREATE_ALWAYS))
		{
			return false;
		}
	...
	bool Builder::SaveTests(const std::wstring& outDir, size_t numTestFiles)
	{
		{
	...
	void Builder::addInstructionFlags(void)
	{
		...
		InstFlags flags[] = {
			...
			{ "ADC",  PackedCpuFlag::OVERFLOW | PackedCpuFlag::SIGN | PackedCpuFlag::ZERO | PackedCpuFlag::AUX | PackedCpuFlag::PARITY | PackedCpuFlag::CARRY, PackedCpuFlag::CARRY },
			{ "ADD",  PackedCpuFlag::OVERFLOW | PackedCpuFlag::SIGN | PackedCpuFlag::ZERO | PackedCpuFlag::AUX | PackedCpuFlag::PARITY | PackedCpuFlag::CARRY },
			...
			{ "CMP",  PackedCpuFlag::OVERFLOW | PackedCpuFlag::SIGN | PackedCpuFlag::ZERO | PackedCpuFlag::AUX | PackedCpuFlag::PARITY | PackedCpuFlag::CARRY },
			{ "CMPXCHG",  PackedCpuFlag::OVERFLOW | PackedCpuFlag::SIGN | PackedCpuFlag::ZERO | PackedCpuFlag::AUX | PackedCpuFlag::PARITY | PackedCpuFlag::CARRY },
			{ "CMPXCHG8B",  PackedCpuFlag::ZERO, 0, 0 },
			{ "CMPXCHG16B",  PackedCpuFlag::ZERO, 0, 0 }, // Same inst as previous.
			{ "COMSID", PackedCpuFlag::ZERO | PackedCpuFlag::PARITY | PackedCpuFlag::CARRY, 0 },
			{ "COMISS",  PackedCpuFlag::ZERO | PackedCpuFlag::PARITY | PackedCpuFlag::CARRY },
			...
			{ "DEC",  PackedCpuFlag::OVERFLOW | PackedCpuFlag::SIGN | PackedCpuFlag::ZERO | PackedCpuFlag::AUX | PackedCpuFlag::PARITY },
			...
			{ "FCOMI",  PackedCpuFlag::ZERO | PackedCpuFlag::PARITY | PackedCpuFlag::CARRY },
			{ "FCOMIP",  PackedCpuFlag::ZERO | PackedCpuFlag::PARITY | PackedCpuFlag::CARRY },
			{ "FUCOMI",  PackedCpuFlag::ZERO | PackedCpuFlag::PARITY | PackedCpuFlag::CARRY },
			{ "FUCOMIP",  PackedCpuFlag::ZERO | PackedCpuFlag::PARITY | PackedCpuFlag::CARRY },
			...
			{ "INC",  PackedCpuFlag::OVERFLOW | PackedCpuFlag::SIGN | PackedCpuFlag::ZERO | PackedCpuFlag::AUX | PackedCpuFlag::PARITY },
			{ "UCOMSID",  PackedCpuFlag::ZERO | PackedCpuFlag::PARITY | PackedCpuFlag::CARRY },
			{ "UCOMISS",  PackedCpuFlag::ZERO | PackedCpuFlag::PARITY | PackedCpuFlag::CARRY },
			{ "IRET",  PackedCpuFlag::OVERFLOW | PackedCpuFlag::SIGN | PackedCpuFlag::ZERO | PackedCpuFlag::AUX | PackedCpuFlag::PARITY | PackedCpuFlag::CARRY | PackedCpuFlag::INTERRUPT | PackedCpuFlag::DIRECTION },
			...
			{ "NEG",  PackedCpuFlag::OVERFLOW | PackedCpuFlag::SIGN | PackedCpuFlag::ZERO | PackedCpuFlag::AUX | PackedCpuFlag::PARITY | PackedCpuFlag::CARRY },
			{ "OR",  PackedCpuFlag::SIGN | PackedCpuFlag::ZERO | PackedCpuFlag::PARITY, PackedCpuFlag::AUX },
			{ "POPCNT",  PackedCpuFlag::ZERO, 0, 0 },
			{ "POPF",  PackedCpuFlag::OVERFLOW | PackedCpuFlag::SIGN | PackedCpuFlag::ZERO | PackedCpuFlag::AUX | PackedCpuFlag::PARITY | PackedCpuFlag::CARRY | PackedCpuFlag::INTERRUPT | PackedCpuFlag::DIRECTION },
			{ "RSM",  PackedCpuFlag::OVERFLOW | PackedCpuFlag::SIGN | PackedCpuFlag::ZERO | PackedCpuFlag::AUX | PackedCpuFlag::PARITY | PackedCpuFlag::CARRY | PackedCpuFlag::INTERRUPT | PackedCpuFlag::DIRECTION },
			{ "SAHF",  PackedCpuFlag::SIGN | PackedCpuFlag::ZERO | PackedCpuFlag::AUX | PackedCpuFlag::PARITY | PackedCpuFlag::CARRY },
			{ "SBB",  PackedCpuFlag::OVERFLOW | PackedCpuFlag::SIGN | PackedCpuFlag::ZERO | PackedCpuFlag::AUX | PackedCpuFlag::PARITY | PackedCpuFlag::CARRY, PackedCpuFlag::CARRY },
			{ "STC",  PackedCpuFlag::CARRY, 0, 0 },
			{ "STD",  PackedCpuFlag::DIRECTION, 0, 0 },
			{ "STI",  PackedCpuFlag::INTERRUPT, 0, 0 },
			{ "SUB",  PackedCpuFlag::OVERFLOW | PackedCpuFlag::SIGN | PackedCpuFlag::ZERO | PackedCpuFlag::AUX | PackedCpuFlag::PARITY | PackedCpuFlag::CARRY },
			...
			{ "XADD",  PackedCpuFlag::OVERFLOW | PackedCpuFlag::SIGN | PackedCpuFlag::ZERO | PackedCpuFlag::AUX | PackedCpuFlag::PARITY | PackedCpuFlag::CARRY },
			...
			{ "CMPS",  PackedCpuFlag::OVERFLOW | PackedCpuFlag::SIGN | PackedCpuFlag::ZERO | PackedCpuFlag::AUX | PackedCpuFlag::PARITY | PackedCpuFlag::CARRY, PackedCpuFlag::DIRECTION },
			{ "SCAS",  PackedCpuFlag::OVERFLOW | PackedCpuFlag::SIGN | PackedCpuFlag::ZERO | PackedCpuFlag::AUX | PackedCpuFlag::PARITY | PackedCpuFlag::CARRY, PackedCpuFlag::DIRECTION },
