...
TEST(x86_SSE, MAXSS_O_XMM_XMM_32)
{
...
TEST(x86_SSE2, CVTPS2PD_O_XMM_XMM_64)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, CVTDQ2PS_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, MOVNTI_O_MEM_32_64_REG_32_64)
{
	Instruction instructions[0x8];
	size_t instructionCount;
	...
	const uint8_t pOps[0x38] = {
		0xf, 0xc3, 0xc, 0x95, 0x78, 0x56, 0x34, 0x12,  /* MOVNTI [edx*4+0x12345678], ECX */
		0xf, 0xc3, 0x14, 0x95, 0x78, 0x56, 0x34, 0x12,  /* MOVNTI [edx*4+0x12345678], EDX */
		0xf, 0xc3, 0x1c, 0x95, 0x78, 0x56, 0x34, 0x12,  /* MOVNTI [edx*4+0x12345678], EBX */
		0xf, 0xc3, 0x24, 0x95, 0x78, 0x56, 0x34, 0x12,  /* MOVNTI [edx*4+0x12345678], ESP */
		0xf, 0xc3, 0x2c, 0x95, 0x78, 0x56, 0x34, 0x12,  /* MOVNTI [edx*4+0x12345678], EBP */
		0xf, 0xc3, 0x34, 0x95, 0x78, 0x56, 0x34, 0x12,  /* MOVNTI [edx*4+0x12345678], ESI */
		0xf, 0xc3, 0x3c, 0x95, 0x78, 0x56, 0x34, 0x12   /* MOVNTI [edx*4+0x12345678], EDI */
	};
...
TEST(x86_SSE2, PADDQ_O_XMM_XMM_64)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PMULUDQ_O_XMM_XMM_64)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSUBQ_O_XMM_XMM_64)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, MOVUPD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, MOVUPD_O_XMM_128_XMM)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, MOVLPD_O_XMM_MEM_64)
{
	Instruction instructions[0x8];
	size_t instructionCount;
	...
	const uint8_t pOps[0x12] = {
		0x66, 0xf, 0x12, 0x4, 0x95, 0x78, 0x56, 0x34, 0x12,  /* MOVLPD xmm0, [edx*4+0x12345678] */
		0x66, 0xf, 0x12, 0xc, 0x95, 0x78, 0x56, 0x34, 0x12   /* MOVLPD xmm1, [edx*4+0x12345678] */
	};

	uint32_t options = 0;
	options |= DisOptions::STOP_ON_FLOW;

	CodeStream strm(0, pOps, 0x12, options, CodeType::CODE_32BIT);
	...
	ASSERT_EQ(0x2_sz, instructionCount);
	{
		...
		ValidateOperand(inst.ops[0], OperandTypeAbs::REG, RegIndex::XMM0, 0x80, __FILE__, __LINE__); // set! (reg idx: 0x6c)
		ValidateOperand(inst.ops[1], OperandTypeAbs::MEM, RegIndex::EDX, 0x40, __FILE__, __LINE__); // set! (reg idx: 0x2)
		ValidateOperandNotSet(inst.ops[2], __FILE__, __LINE__); // ns
		ValidateOperandNotSet(inst.ops[3], __FILE__, __LINE__); // ns
	}
	{
		/* MOVLPD xmm1, [edx*4+0x12345678] */
		const Instruction& inst = instructions[0x1];
		ValidateInstruction(inst,
			InstructionID::MOVLPD,
			FlowControl::NONE,
...
TEST(x86_SSE2, MOVLPD_O_MEM_64_XMM)
{
	Instruction instructions[0x8];
	size_t instructionCount;
	...
	// ops: 0xf 0x13 
	const uint8_t pOps[0x12] = {
		0x66, 0xf, 0x13, 0x4, 0x95, 0x78, 0x56, 0x34, 0x12,  /* MOVLPD [edx*4+0x12345678], xmm0 */
		0x66, 0xf, 0x13, 0xc, 0x95, 0x78, 0x56, 0x34, 0x12   /* MOVLPD [edx*4+0x12345678], xmm1 */
	};
...
TEST(x86_SSE2, UNPCKLPD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, UNPCKHPD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, MOVHPD_O_XMM_MEM_64)
{
	Instruction instructions[0x8];
	size_t instructionCount;
	...
	// ops: 0xf 0x16 
	const uint8_t pOps[0x12] = {
		0x66, 0xf, 0x16, 0x4, 0x95, 0x78, 0x56, 0x34, 0x12,  /* MOVHPD xmm0, [edx*4+0x12345678] */
		0x66, 0xf, 0x16, 0xc, 0x95, 0x78, 0x56, 0x34, 0x12   /* MOVHPD xmm1, [edx*4+0x12345678] */
	};
...
TEST(x86_SSE2, MOVHPD_O_MEM_64_XMM)
{
	Instruction instructions[0x8];
	size_t instructionCount;
	...
	// ops: 0xf 0x17 
	const uint8_t pOps[0x12] = {
		0x66, 0xf, 0x17, 0x4, 0x95, 0x78, 0x56, 0x34, 0x12,  /* MOVHPD [edx*4+0x12345678], xmm0 */
		0x66, 0xf, 0x17, 0xc, 0x95, 0x78, 0x56, 0x34, 0x12   /* MOVHPD [edx*4+0x12345678], xmm1 */
	};
...
TEST(x86_SSE2, MOVAPD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, MOVAPD_O_XMM_128_XMM)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, CVTPI2PD_O_XMM_MM_64)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, MOVNTPD_O_MEM_128_XMM)
{
	Instruction instructions[0x8];
	size_t instructionCount;
	...
	// ops: 0xf 0x2b 
	const uint8_t pOps[0x12] = {
		0x66, 0xf, 0x2b, 0x4, 0x95, 0x78, 0x56, 0x34, 0x12,  /* MOVNTPD [edx*4+0x12345678], xmm0 */
		0x66, 0xf, 0x2b, 0xc, 0x95, 0x78, 0x56, 0x34, 0x12   /* MOVNTPD [edx*4+0x12345678], xmm1 */
	};
...
TEST(x86_SSE2, CVTTPD2PI_O_MM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, CVTPD2PI_O_MM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, UCOMISD_O_XMM_XMM_64)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, COMISD_O_XMM_XMM_64)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, MOVMSKPD_O_REG_32_XMM_RM)
{
...
TEST(x86_SSE2, SQRTPD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, ANDPD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, ANDNPD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, ORPD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, XORPD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, ADDPD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, MULPD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, CVTPD2PS_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, CVTPS2DQ_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, SUBPD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, MINPD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, DIVPD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, MAXPD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PUNPCKLBW_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PUNPCKLWD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PUNPCKLDQ_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PACKSSWB_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PCMPGTB_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PCMPGTW_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PCMPGTD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PACKUSWB_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PUNPCKHBW_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PUNPCKHWD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PUNPCKHDQ_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PACKSSDW_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PUNPCKLQDQ_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PUNPCKHQDQ_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, MOVDQA_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSRLW_O_XMM_RM_IMM_8)
{
	Instruction instructions[0x8];
	size_t instructionCount;
	...
	CodeStream strm(0, pOps, 0xa, options, CodeType::CODE_32BIT);
...
TEST(x86_SSE2, PSRAW_O_XMM_RM_IMM_8)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSLLW_O_XMM_RM_IMM_8)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSRLD_O_XMM_RM_IMM_8)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSRAD_O_XMM_RM_IMM_8)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSLLD_O_XMM_RM_IMM_8)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSRLQ_O_XMM_RM_IMM_8)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSRLDQ_O_XMM_RM_IMM_8)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSLLQ_O_XMM_RM_IMM_8)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSLLDQ_O_XMM_RM_IMM_8)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PCMPEQB_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PCMPEQW_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PCMPEQD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, MOVDQA_O_XMM_128_XMM)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSRLW_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSRLD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSRLQ_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PADDQ_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PMULLW_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, MOVQ_O_XMM_64_XMM)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PMOVMSKB_O_REG_32_XMM_RM)
{
	Instruction instructions[0x10];
	size_t instructionCount;
...
TEST(x86_SSE2, PSUBUSB_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSUBUSW_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PMINUB_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PAND_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PADDUSB_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PADDUSW_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PMAXUB_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PANDN_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PAVGB_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSRAW_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSRAD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PAVGW_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PMULHUW_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PMULHW_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, CVTTPD2DQ_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSUBSB_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSUBSW_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PMINSW_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, POR_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PADDSB_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PADDSW_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PMAXSW_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PXOR_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSLLW_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSLLD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSLLQ_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PMULUDQ_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PMADDWD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSADBW_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, MASKMOVDQU_O_XMM_XMM_RM)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSUBB_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSUBW_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSUBD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PSUBQ_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PADDB_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PADDW_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, PADDD_O_XMM_XMM_128)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, MOVSD_O_XMM_XMM_64)
{
	Instruction instructions[0x8];
	size_t instructionCount;
...
TEST(x86_SSE2, MOVSD_O_XMM_64_XMM)
{
	Instruction instructions[0x8];
	size_t instructionCount;
